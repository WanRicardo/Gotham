...
public class TelaMenuPolicia extends JFrame {
	...
	public TelaMenuPolicia() {
		setTitle("GCPD - Gerenciar Cadastros de Policiais");
		...
		scrLista = new JScrollPane(MenuController.getInstance().getTblListaPolicia());
		centro.add(scrLista);

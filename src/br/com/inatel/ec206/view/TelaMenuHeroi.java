...
public class TelaMenuHeroi extends JFrame {
	...
	public TelaMenuHeroi() {
		setTitle("GCPD - Gerenciar Cadastros de Heróis");
		...
		scrLista = new JScrollPane(MenuController.getInstance().getTblListaHeroi());
		centro.add(scrLista);

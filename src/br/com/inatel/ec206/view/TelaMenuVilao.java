...
public class TelaMenuVilao extends JFrame {
	...
	public TelaMenuVilao() {
		setTitle("GCPD - Gerenciar Cadastros de Vilões");
		...
		scrLista = new JScrollPane(MenuController.getInstance().getTblListaViloes());
		centro.add(scrLista);
